  ...
  , mMousePrecisionDecimalPlaces( 0 )
{
  ...
  mLabel->setText( tr( "坐标" ) );
  mLabel->setToolTip( tr( "当前地图坐标" ) );
  ...
  mLineEdit->setToolTip( tr( "当前地图坐标 (经度,纬度)" ) );
  ...
  mToggleExtentsViewButton->setToolTip( tr( "切换地图范围/鼠标坐标显示模式" ) );
...
void QgsStatusBarCoordinatesWidget::extentsViewToggled( bool flag )
{
  if ( flag )
  {
    ...
    mLineEdit->setToolTip( tr( "当前视图范围坐标" ) );
  ...
  else
  {
    ...
    mToggleExtentsViewButton->setIcon( QgsApplication::getThemeIcon( QStringLiteral( "tracking.svg" ) ) );
    mLineEdit->setToolTip( tr( "鼠标所在地图坐标" ) );
  ...
  switch ( order )
  {
    case Qgis::CoordinateOrder::XY:
      if ( coordinateCrs.isGeographic() )
        ...
        mLineEdit->setToolTip( tr( "当前地图坐标 (东, 北)" ) );
      break;
    case Qgis::CoordinateOrder::YX:
      if ( coordinateCrs.isGeographic() )
        mLineEdit->setToolTip( tr( "当前地图坐标 (纬度, 经度)" ) );
      else
        mLineEdit->setToolTip( tr( "当前地图坐标 (北, 东)" ) );
      break;
    case Qgis::CoordinateOrder::Default:
      break;
  }
